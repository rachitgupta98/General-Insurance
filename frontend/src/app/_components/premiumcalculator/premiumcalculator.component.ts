        ...
        if (this.numberOfYear == 1) {
          for (var i = 0; i < this.vehicleCarManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleCarManufacturer[i].price) -
                parseInt(this.vehicleCarManufacturer[i].price) * 0.1;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = true;
        ...
        if (this.numberOfYear > 1 && this.numberOfYear < 3) {
          for (var i = 0; i < this.vehicleCarManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleCarManufacturer[i].price) -
                parseInt(this.vehicleCarManufacturer[i].price) * 0.15;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = true;
        ...
        if (this.numberOfYear > 2 && this.numberOfYear < 10) {
          for (var i = 0; i < this.vehicleCarManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleCarManufacturer[i].price) -
                parseInt(this.vehicleCarManufacturer[i].price) * 0.2;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = true;
        ...
        if (this.numberOfYear >= 10) {
          for (var i = 0; i < this.vehicleCarManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleCarManufacturer[i].price) -
                parseInt(this.vehicleCarManufacturer[i].price) * 0.5;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = true;
        ...
        if (this.numberOfYear == 1) {
          for (var i = 0; i < this.vehicleBikeManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleBikeManufacturer[i].price) -
                parseInt(this.vehicleBikeManufacturer[i].price) * 0.1;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = !this.flag;
        ...
        if (this.numberOfYear > 1 && this.numberOfYear < 3) {
          for (var i = 0; i < this.vehicleBikeManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleBikeManufacturer[i].price) -
                parseInt(this.vehicleBikeManufacturer[i].price) * 0.15;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = !this.flag;
        ...
        if (this.numberOfYear > 2 && this.numberOfYear < 10) {
          for (var i = 0; i < this.vehicleBikeManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleBikeManufacturer[i].price) -
                parseInt(this.vehicleBikeManufacturer[i].price) * 0.2;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = !this.flag;
        ...
        if (this.numberOfYear >= 10) {
          for (var i = 0; i < this.vehicleBikeManufacturer.length; i++) {
            ...
            if (
              ...
              this.idvValue =
                parseInt(this.vehicleBikeManufacturer[i].price) -
                parseInt(this.vehicleBikeManufacturer[i].price) * 0.5;
              this.odValue = 0.0197 * this.idvValue;
            }
          }
          this.flag = true;
